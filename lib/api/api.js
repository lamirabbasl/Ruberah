...
export async function approveReceiptPayment(registrationId) {
  try {
    const res = await api.post(`courses/manage/registrations/${registrationId}/approve-receipt/`, {
...
export async function getBatchTermById(termId) {
  try {
    const res = await api.get(`courses/batches/${termId}/required-terms/`);
    return res.data;
  } catch (error) {
    console.error("Error searching child:", error.message);
    throw error;
...
export async function getBatchBankAccountById(batchId) {
  try {
    const res = await api.get(`courses/batches/${batchId}/payment-accounts/`);
    return res.data;
  } catch (error) {
    console.error("Error searching child:", error.message);
    throw error;
...
export async function searchBankAccount(search) {
  try {
    ...
    const res = await api.get(`courses/manage/payment-accounts/?${params.toString()}`);
    return res.data;
  } catch (error) {
...
export async function getTerms() {
  try {
    const res = await api.get("courses/manager/terms-rules");
    return res.data;
  } catch (error) {
    console.error("Error fetching accounts:", error.message);
    throw error;
...
export async function addTrems(termData) {
  try {
    const res = await api.post("courses/manager/terms-rules/", termData);
    return res.data;
  } catch (error) {
    console.error("Error adding account:", error.message);
    throw error;
...
export async function editTrems(termId , termData) {
  try {
    const res = await api.patch(`courses/manager/terms-rules/${termId}/`, termData);
    return res.data;
  } catch (error) {
    console.error("Error adding account:", error.message);
    throw error;
...
export async function deleteTerms(termId) {
  try {
    const res = await api.delete(`courses/manager/terms-rules/${termId}/`);
    return res.data;
  } catch (error) {
    console.error("Error deleting account:", error.message);
    throw error;
...
export async function searchTerms(search) {
  try {
    const params = new URLSearchParams({ seach: search });
    const res = await api.get(`courses/manage/terms-rules/?${params.toString()}`);
    return res.data;
  } catch (error) {
    console.error("Error searching seasons:", error.message);
    throw error;
...
export async function getSessionsById(id) {
  try {
    const res = await api.get(`intro/sessions/manage/${id}`);
    return res.data;
  } catch (error) {
...
export async function patchUser(id , formData) {
  try {
    const res = await api.patch(`users/manage/${id}/`, formData);
    return res.data;
  } catch (error) {
...
export async function getRegistrationsAdmin(page = 1, search = '', batch = null, payment_status = '', approval_status = '') {
  try {
    const searchQueryParam = search ? `&search=${search}` : '';
    const batchParam = batch ? `&batch=${batch}` : '';
    const paymentParam = payment_status ? `&payment_status=${payment_status}` : '';
    const approvalParam = approval_status ? `&approval_status=${approval_status}` : '';
    const res = await api.get(`courses/manage/registrations/?page=${page}${searchQueryParam}${batchParam}${paymentParam}${approvalParam}`);
    return res.data;
  } catch (error) {
    console.error("Error fetching registrations:", error.message);
    throw error;
...
export async function getUsers(page = 1, searchTerm = "", groupFilter = "") {
  try {
    const params = { page };
    if (searchTerm) {
    ...
    if (groupFilter) {
      params.group = groupFilter; // Add group filter to query params
    }
...
export async function getAnotherParentById(id) {
  try {
    const res = await api.get(`users/manage/${id}/another-parent`);
    return res.data;
  } catch (error) {
    console.error("Error fetching users:", error.message);
    throw error;
...
// Reservations
export async function getReservations(page = 1, queryString = "") {
  try {
    const res = await api.get(`intro/reservations/?${queryString}`);
    return res.data;
  } catch (error) {
...
export async function uploadInstallmentPayment(installmentId, file, paymentAccount) {
  try {
    const formData = new FormData();
    formData.set("receipt_image", file);
    if (paymentAccount) {
      formData.set("payment_account", paymentAccount);
    }
...
export async function UploadReceiptPicture(receiptId, file, paymentAccount) {
  try {
    const formData = new FormData();
    formData.set("receipt_image", file);
    if (paymentAccount) {
    ...
    console.error("Error uploading receipt picture:", error?.response?.data || error.message);
    throw error;
  }
}
...
export async function getUsersExport() {
  try {
    const res = await api.get(`users/manage/exports/users/`, { 
        responseType: "blob",     
    });
    return res.data;
  } catch (error) {
...
export async function getRegistrationExport() {
  try {
...
export async function getReservesExport() {
  try {
    const res = await api.get(`intro/manage/exports/intro-reservations/`, { 
        responseType: "blob",     
    });
    return res.data;
  } catch (error) {
...
export async function rejectUserSignup(regId) {
  try {
    const res = await api.post(`courses/manage/registrations/${regId}/reject/`);
    return res.data;
  } catch (error) {
    console.error("Error adding installment templates:", error.message);
    throw error;
...
export async function approveUserSignup(regId) {
  try {
    const res = await api.post(`courses/manage/registrations/${regId}/manual-approve/`);
    return res.data;
  } catch (error) {
    console.error("Error adding installment templates:", error.message);
    throw error;
...
export async function rejectInstallment(instId) {
  try {
    const res = await api.post(`courses/manage/installments/${instId}/reject-receipt/`);
    return res.data;
  } catch (error) {
    console.error("Error adding installment templates:", error.message);
    throw error;
...
export async function rejectReceipt(recId) {
  try {
    const res = await api.post(`courses/manage/registrations/${recId}/reject-receipt/`);
    return res.data;
  } catch (error) {
    console.error("Error adding installment templates:", error.message);
    throw error;
...
export async function sendReceiptSMS(formData) {
  try {
    const res = await api.post(`courses/manage/batches/notify-missing-receipts/`, formData);
    return res.data;
  } catch (error) {
    console.error("Error adding installment templates:", error.message);
    throw error;
...
export async function removeMissingReceipt(formData) {
  try {
    const res = await api.post(`courses/manager/registrations/purge-missing-receipts/`, formData );
    return res.data;
  } catch (error) {
    console.error("Error:", error.message);
    throw error;
...
export async function getBatchPricing(batchId, childId, paymentMethod) {
  try {
    const res = await api.get(`courses/batches/${batchId}/pricing/`, {
      params: {
        child: childId,
        payment_method: paymentMethod,
      },
    ...
    console.error("Error fetching batch pricing:", error.message);
    throw error;
  }
}
