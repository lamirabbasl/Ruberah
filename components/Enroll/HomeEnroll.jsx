      ...
      <div className='flex flex-col items-end gap-8 w-3/7 h-4/5 border-2 border-white rounded-lg bg-gray-950 p-8 max-md:w-[95%] max-md:h-auto'>
        ...
        <div dir="rtl">
          <ul className="list-disc text-right gap-2 pr-6 space-y-4">
            <li>برای بهبود و افزایش کارایی لطفا تمام ویدیو های نمایش داده شده را تا انتها تماشا کنید</li>
            <li>لطفا تمام سوالات نمایش داده شده را جواب داده سپس وارد روند ثبت نام شوید</li>
            <li>سپس وارد روند احراز هویت شده </li>
            <li>ابتدا توسط پیامک شماره تلفن شما تایید می شود</li>
            <li>پس از تایید شماره تماس شما می بایست در یک جلسه مصاحبه برای آشنایی و تکمیل اطلاعات شرکت فرمایید</li>
