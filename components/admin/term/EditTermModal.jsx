    ...
    <AnimatePresence>
      {showEditForm && (
        ...
        >
          ...
          >
            <h3 className="text-xl font-bold text-gray-900 mb-6 tracking-tight">ویرایش شرایط</h3>
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setEditingTerm({ ...editingTerm, body: e.target.value })}
                  className="w-full border border-gray-200 rounded-lg px-4 py-3 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 text-sm"
              ...
              <div>
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={editingTerm?.is_active || false}
