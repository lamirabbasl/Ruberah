    ...
    <AnimatePresence>
      {showEditForm && (
        ...
        >
          ...
          >
            <h3 className="text-xl font-bold text-gray-900 mb-6 tracking-tight">ویرایش حساب بانکی</h3>
            <div className="space-y-5">
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">نام نمایشی</label>
                <input
                  type="text"
                  value={editingBankAccount?.display_name || ""}
                  onChange={(e) => setEditingBankAccount({ ...editingBankAccount, display_name: e.target.value })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingBankAccount({ ...editingBankAccount, bank_name: e.target.value })}
                  className="w-full border border-gray-200 rounded-lg px-4 py-3 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 text-sm"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingBankAccount({ ...editingBankAccount, iban: e.target.value })}
                  className="w-full border border-gray-200 rounded-lg px-4 py-3 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 text-sm"
              ...
              <div>
                ...
                <input
                  type="text"
                  value={editingBankAccount?.card_number || ""}
                  onChange={(e) => setEditingBankAccount({ ...editingBankAccount, card_number: e.target.value })}
                  className="w-full border border-gray-200 rounded-lg px-4 py-3 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200 text-sm"
              ...
              <div>
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    checked={editingBankAccount?.is_active || false}
