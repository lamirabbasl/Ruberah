...
function DeleteConfirmModal({ showDeleteConfirm, accountToDelete, cancelDelete, handleDeleteBankAccount }) {
  return (
    <AnimatePresence>
      {showDeleteConfirm && (
        <motion.div
        ...
        >
          ...
          >
            <p className="mb-6 text-red-600 font-semibold text-center text-lg">
              آیا از حذف حساب بانکی "{accountToDelete?.display_name}" مطمئن هستید؟
            </p>
